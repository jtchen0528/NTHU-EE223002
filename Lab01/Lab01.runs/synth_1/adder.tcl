...
read_verilog -library xil_defaultlib {{D:/Jack/NTHU/2018_spring/LD exp/Lab01/Lab01.srcs/sources_1/new/adder.v}}
foreach dcp [get_files -quiet -all *.dcp] {
  set_property used_in_implementation false $dcp
}
read_xdc {{D:/Jack/NTHU/2018_spring/LD exp/Lab01/Lab01.srcs/constrs_1/new/YOUR_XDC.xdc}}
set_property used_in_implementation false [get_files {{D:/Jack/NTHU/2018_spring/LD exp/Lab01/Lab01.srcs/constrs_1/new/YOUR_XDC.xdc}}]
