...
set rc [catch {
  ...
  set_property ip_repo_paths {{d:/Jack/NTHU/2018_spring/LD exp/Lab10/Lab103/Lab103.cache/ip}} [current_project]
  set_property ip_output_repo {{d:/Jack/NTHU/2018_spring/LD exp/Lab10/Lab103/Lab103.cache/ip}} [current_project]
  add_files -quiet {{D:/Jack/NTHU/2018_spring/LD exp/Lab10/Lab103/Lab103.runs/synth_1/speaker.dcp}}
