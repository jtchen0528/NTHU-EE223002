    ...
    case(state)
        3'd0: begin
           if(CODEWORD != RELEASE) begin
               if(CODEWORD == z) notes2 <= 5'd9;
               if(CODEWORD == x) notes2 <= 5'd10;
               if(CODEWORD == c) notes2 <= 5'd11;
               if(CODEWORD == v) notes2 <= 5'd12;
               if(CODEWORD == b) notes2 <= 5'd13;
               if(CODEWORD == n) notes2 <= 5'd14;
               if(CODEWORD == m) notes2 <= 5'd15;
           end
           else begin
               notes2 <= 5'd16;
               state <= 3'd1;
        ...
        3'd1: begin
            if(CNT2 == CNT) begin notes2 <= 5'd16; end
            else if (CNT2 > CNT) begin notes2 <= 5'd16; end
