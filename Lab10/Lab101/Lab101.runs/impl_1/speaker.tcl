...
set rc [catch {
  ...
  set_property webtalk.parent_dir {D:/Jack/NTHU/2018_spring/LD exp/Lab10/Lab101/Lab101.cache/wt} [current_project]
  set_property parent.project_path {D:/Jack/NTHU/2018_spring/LD exp/Lab10/Lab101/Lab101.xpr} [current_project]
  set_property ip_repo_paths {{d:/Jack/NTHU/2018_spring/LD exp/Lab10/Lab101/Lab101.cache/ip}} [current_project]
  set_property ip_output_repo {{d:/Jack/NTHU/2018_spring/LD exp/Lab10/Lab101/Lab101.cache/ip}} [current_project]
  add_files -quiet {{D:/Jack/NTHU/2018_spring/LD exp/Lab10/Lab101/Lab101.runs/synth_1/speaker.dcp}}
  read_xdc {{D:/Jack/NTHU/2018_spring/LD exp/Lab10/Lab101/Lab101.srcs/constrs_1/new/Lab101_XDC.xdc}}
