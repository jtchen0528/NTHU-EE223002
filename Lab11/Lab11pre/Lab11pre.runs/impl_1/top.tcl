...
set rc [catch {
  ...
  set_property webtalk.parent_dir {D:/Jack/NTHU/2018_spring/LD exp/Lab11/Lab11pre/Lab11pre.cache/wt} [current_project]
  set_property parent.project_path {D:/Jack/NTHU/2018_spring/LD exp/Lab11/Lab11pre/Lab11pre.xpr} [current_project]
  set_property ip_repo_paths {{d:/Jack/NTHU/2018_spring/LD exp/Lab11/Lab11pre/Lab11pre.cache/ip}} [current_project]
  set_property ip_output_repo {{d:/Jack/NTHU/2018_spring/LD exp/Lab11/Lab11pre/Lab11pre.cache/ip}} [current_project]
  add_files -quiet {{D:/Jack/NTHU/2018_spring/LD exp/Lab11/Lab11pre/Lab11pre.runs/synth_1/top.dcp}}
  read_xdc {{D:/Jack/NTHU/2018_spring/LD exp/Lab11/lab11_VGA_source/demo1/Basys3_Master.xdc}}
