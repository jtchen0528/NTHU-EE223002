...
set rc [catch {
  ...
  set_property webtalk.parent_dir {D:/Jack/NTHU/2018_spring/LD exp/Exam/exam3/exam3.cache/wt} [current_project]
  set_property parent.project_path {D:/Jack/NTHU/2018_spring/LD exp/Exam/exam3/exam3.xpr} [current_project]
  set_property ip_repo_paths {{d:/Jack/NTHU/2018_spring/LD exp/Exam/exam3/exam3.cache/ip}} [current_project]
  set_property ip_output_repo {{d:/Jack/NTHU/2018_spring/LD exp/Exam/exam3/exam3.cache/ip}} [current_project]
  add_files -quiet {{D:/Jack/NTHU/2018_spring/LD exp/Exam/exam3/exam3.runs/synth_1/top.dcp}}
  read_xdc {{D:/Jack/NTHU/2018_spring/LD exp/Exam/exam3/exam3.srcs/constrs_1/new/exam3_XDC.xdc}}
