...
set rc [catch {
  ...
  set_property webtalk.parent_dir {D:/Jack/NTHU/2018_spring/LD exp/Lab09/Lab093/Lab093.cache/wt} [current_project]
  set_property parent.project_path {D:/Jack/NTHU/2018_spring/LD exp/Lab09/Lab093/Lab093.xpr} [current_project]
  set_property ip_repo_paths {{d:/Jack/NTHU/2018_spring/LD exp/Lab09/Lab093/Lab093.cache/ip}} [current_project]
  set_property ip_output_repo {{d:/Jack/NTHU/2018_spring/LD exp/Lab09/Lab093/Lab093.cache/ip}} [current_project]
  add_files -quiet {{D:/Jack/NTHU/2018_spring/LD exp/Lab09/Lab093/Lab093.runs/synth_1/wrapper.dcp}}
