...
//	wire [7:0]S = 8'h1B;
	...
	always @(posedge CLK) begin
         if(state == 3'd0)begin
            if(CODEWORD != temp)begin
	       on <= 1;
	       temp <= CODEWORD;
           if (CODEWORD == ONE) N <= 8'd1;
           else if (CODEWORD == TWO) N <= 8'd2;
           else if (CODEWORD == THREE) N <= 8'd3;
           else if (CODEWORD == FOUR) N <= 8'd4;
           else if (CODEWORD == FIVE) N <= 8'd5;
           else if (CODEWORD == SIX) N <= 8'd6;
           else if (CODEWORD == SEVEN) N <= 8'd7;
           else if (CODEWORD == EIGHT) N <= 8'd8;
           else if (CODEWORD == NINE) N <= 8'd9;
           else if (CODEWORD == ZERO) N <= 8'd0;
           else if (CODEWORD == DOT)begin state <= 3'd1; end
           end
        end
           ...
           else if (CODEWORD == ENTER)begin state <= 3'd2; end
        end
        else if(state == 3'd2)begin
            if(CODEWORD == PLUS) begin A = N1*10 + N2; state = 3'd3; mode = 2'd0; end
            if(CODEWORD == MINUS) begin A = N1*10 + N2; state = 3'd3; mode = 2'd1; end
            if(CODEWORD == MULTI) begin A = N1*10 + N2; state = 3'd3; mode = 2'd2; end
            if(CODEWORD == DE) begin A = N1*10 + N2; state = 3'd3; mode = 2'd3; end
        end
